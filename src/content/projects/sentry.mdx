...
so, before we start, let's get you guys up to speed first. this project was in collaboration of a program called <a class="mdx-link" href="https://www.dicoding.com/asah" target="_blank" rel="noopener noreferrer">dicoding asah</a>,
...
since we don't have access to a real dataset, we were told to use this dataset called <a class="mdx-link" href="https://www.kaggle.com/datasets/shivamb/machine-predictive-maintenance-classification/data" target="_blank" rel="noopener noreferrer">machine-predictive-maintenance-classification</a>, which is a synthetic dataset that reflects real predictive maintenance encountered in the industry to the best of their knowledge.
